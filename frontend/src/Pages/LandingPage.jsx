...
function LandingPage(){
    ...
    return (
        <div className="p-0 m-0 min-h-screen bg-slate-900 bg-gradient-to-b from-violet-600/[.15] via-transparent w-auto">
            {/* <!-- ========== HEADER ========== --> */}
            <header className="sticky top-2 flex flex-wrap md:justify-start md:flex-nowrap z-50 w-full text-sm">
