        ...
        <>
            <main className="w-full max-w-md mx-auto p-6">
                <div className="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    {authError && <p className="text-center text-lg text-red-600 mt-2">{authError}</p>}
                    <div className="p-4 sm:p-7">
                        <div className="text-center">
                            <h1 className="block text-2xl font-bold text-gray-800 dark:text-white">Sign in</h1>
                            <p className="mt-2 text-sm text-gray-600 dark:text-gray-400">
                                Don't have an account yet?
                                <Link to="/signup" className="text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">
                                    Sign up here
                                </Link>
                            </p>
                        </div>
                        ...
                        <div className="mt-5">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div className="grid gap-y-4">
                                    {/* <!-- Form Group --> */}
                                    <div>
                                        <label htmlFor="uname" className="block text-sm mb-2 dark:text-white">Username</label>
                                        <div className="relative">
                                            <input type="text" id="uname" name="uname" className="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error" value={username} onChange={(e) => setUsername(e.target.value)} />
                                        ...
                                        {/* <p className=" text-xs text-red-600 mt-2" id="email-error">Please include a valid username</p> */}
                                    </div>
                                    {/* <!-- End Form Group --> */}
                                    ...
                                    <div>
                                        <div className="flex justify-between items-center">
                                            ...
                                            <a className="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Forgot password?</a>
                                        </div>
                                        <div className="relative">
                                    ...
                                    {/* <div className="flex items-center">
                                        ...
                                        <div className="ms-3">
                                            <label htmlForlFor="remember-me" className="text-sm dark:text-white">Remember me</label>
                                        </div>
                                    </div> */}
                                    ...
                                    {error && <p className="text-center text-lg text-red-600 mt-2">Invalid login credentials</p>}
                                </div>
                            </form>
