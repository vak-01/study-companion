        ...
        <>
            <main class="w-full max-w-md mx-auto p-6">
                <div class="mt-7 bg-white border border-gray-200 rounded-xl shadow-sm dark:bg-gray-800 dark:border-gray-700">
                    {authError && <p class="text-center text-lg text-red-600 mt-2">{authError}</p>}
                        ...
                        <div class="mt-5">
                            ...
                            <form onSubmit={handleSubmit}>
                                <div class="grid gap-y-4">
                                    {/* <!-- Form Group --> */}
                                    <div>
                                        <label for="uname" class="block text-sm mb-2 dark:text-white">Username</label>
                                        <div class="relative">
                                            <input type="text" id="uname" name="uname" class="py-3 px-4 block w-full border-gray-200 rounded-lg text-sm focus:border-blue-500 focus:ring-blue-500 disabled:opacity-50 disabled:pointer-events-none dark:bg-slate-900 dark:border-gray-700 dark:text-gray-400 dark:focus:ring-gray-600" required aria-describedby="email-error" value={username} onChange={(e) => setUsername(e.target.value)} />
                                            <div class=" absolute inset-y-0 end-0 flex items-center pointer-events-none pe-3">
                                                <svg class="h-5 w-5 text-red-500" width="16" height="16" fill="currentColor" viewBox="0 0 16 16" aria-="true">
                                                    <path d="M16 8A8 8 0 1 1 0 8a8 8 0 0 1 16 0zM8 4a.905.905 0 0 0-.9.995l.35 3.507a.552.552 0 0 0 1.1 0l.35-3.507A.905.905 0 0 0 8 4zm.002 6a1 1 0 1 0 0 2 1 1 0 0 0 0-2z" />
                                                </svg>
                                            </div>
                                        </div>
                                        {/* <p class=" text-xs text-red-600 mt-2" id="email-error">Please include a valid username</p> */}
                                    </div>
                                    {/* <!-- End Form Group --> */}
                                    ...
                                    <div>
                                        <div class="flex justify-between items-center">
                                            ...
                                            <a class="text-sm text-blue-600 decoration-2 hover:underline font-medium dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" href="#">Forgot password?</a>
                                        </div>
                                        <div class="relative">
                                    ...
                                    {error && <p class="text-center text-lg text-red-600 mt-2">Invalid login credentials</p>}
                                </div>
                            </form>
