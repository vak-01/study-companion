...
import '../../node_modules/preline/dist/dropdown.js';
import '../../node_modules/preline/dist/accordion.js'

function Goal({ id, goal, description, completed, goals, setGoals }) {
    useEffect(() => {
    ...
    function handlePatch() {
        axios.patch(`http://localhost:8000/goals/${id}/`, null, {
            headers: {
                Authorization: 'Token ' + localStorage.getItem('cp-tkn')
            }
        })
            ...
            <td className="h-px w-px whitespace-nowrap">
                <a className="block relative z-10" href="#">
                    <div className="px-6 py-2">
                        <div className="block text-sm text-blue-600 decoration-2 hover:underline dark:text-blue-500">{goal}</div>
                    </div>
                </a>
            </td>
                ...
                <a className="block relative z-10" href="#">
                    <div className="px-6 py-2">
                        <span className="inline-flex items-center gap-1.5 py-1 px-2 rounded-lg text-xs font-medium bg-gray-100 text-gray-800 dark:bg-gray-900 dark:text-gray-200">
                           {completed ? <p className="bg-lime-500 text-black font-semibold rounded-md p-1">Completed</p> : <p className="bg-red-800 text-white font-semibold rounded-md p-1">Not completed</p>}
                        </span>
                    </div>
                </a>
            </td>
                    ...
                    <div className="hs-dropdown relative inline-block [--placement:bottom-right]">
                        ...
                        <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden divide-y divide-gray-200 min-w-[10rem] z-20 bg-white shadow-2xl rounded-lg p-2 mt-2 dark:divide-gray-700 dark:bg-gray-800 dark:border dark:border-gray-700" aria-labelledby="hs-table-dropdown-1">
                            <div className="py-2 first:pt-0 last:pb-0">
                                ...
                                <button className="flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-gray-800 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-gray-300 dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600" onClick={handlePatch}>
                                    Mark as {completed ? "not completed" : "completed"}
                                </button>
                            </div>
                            <div className="py-2 first:pt-0 last:pb-0">
                                <button className="w-full flex items-center gap-x-3 py-2 px-3 rounded-lg text-sm text-red-600 hover:bg-gray-100 focus:ring-2 focus:ring-blue-500 dark:text-red-500 dark:hover:bg-gray-700 dark:hover:text-gray-300" onClick={handleDelete}>
                                    Delete
                                </button>
                            </div>
                        </div>
                                    ...
                                    <div className="bg-white border border-gray-200 rounded-xl shadow-sm overflow-hidden dark:bg-slate-900 dark:border-gray-700">
                                        ...
                                        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-b border-gray-200 dark:border-gray-700">
                                            ...
                                            <div>
                                                <div className="inline-flex gap-x-2">
                                                        ...
                                                        <div className="hs-dropdown-menu transition-[opacity,margin] duration hs-dropdown-open:opacity-100 opacity-0 hidden  divide-y divide-gray-200 min-w-[12rem] z-20 bg-white shadow-md rounded-lg mt-2 dark:divide-gray-700 dark:bg-gray-800 dark:border dark:border-gray-700" aria-labelledby="hs-as-table-table-filter-dropdown">
                                                            <div className="divide-y divide-gray-200 dark:divide-gray-700">
                                                                <label htmlFor="hs-as-filters-dropdown-frequency" className="flex py-2.5 px-3">
                                                                    ...
                                                                    // onChange={setGoals(goals.filter(goal => goal.completed === true))} 
                                                                    />
                                                                ...
                                                                <label htmlFor="hs-as-filters-dropdown-status" className="flex py-2.5 px-3">
                                                                    ...
                                                                    // onChange={setGoals(goals.filter(goal => goal.completed === false))} 
                                                                    />
                                                   ...
                                                   <NewGoal goals = {goals} setGoals = {setGoals}/>
                                                </div>
                                            </div>
                                        </div>
                                        {/* <!-- End Header --> */}
                                        ...
                                        <table className="min-w-full divide-y divide-gray-200 dark:divide-gray-700">
                                            ...
                                            <tbody className="divide-y divide-gray-200 dark:divide-gray-700">
                                                ...
                                                <tr><td>{ goals.length == 0 && (<p className = "p-3 text-sky-800 text-lg font-bold">No goals created !!</p>)}</td></tr>
                                            </tbody>
                                        ...
                                        <div className="px-6 py-4 grid gap-3 md:flex md:justify-between md:items-center border-t border-gray-200 dark:border-gray-700">
                                            <div>
                                                <p className="text-sm text-gray-600 dark:text-gray-400">
                                                    <span className="font-semibold text-gray-800 dark:text-gray-200">{goals.length}</span> {goals.length == 1 ? "goal" : "goals"}
                                                </p>
                                            </div>
